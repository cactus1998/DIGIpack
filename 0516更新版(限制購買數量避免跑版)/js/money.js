//sub- add+  textbox  single-pay=10.50 quantity subtotal all
// var suball=document.querySelectorAll('.sub');
// var addall=document.querySelectorAll('.add');
// var textboxall=document.querySelectorAll('.textbox');//
// var singlepay=document.querySelectorAll('.single-pay');
// var quantity=document.querySelectorAll('.quantity');
// var subtotal=document.querySelectorAll('.subtotal');
// var shippingfee = document.querySelector('.shipping-fee');
// var allpay=document.querySelectorAll('.all');
// var textboxBefore=0;
...
function add_or_sub(choice,index) {
    ...
    switch(choice) {
        case "+" :
            amountAll[index].value = (tempAmount < 10) ?  ++tempAmount : tempAmount ;  //計算數量 最多只能買10個
            break;
        case "-" :
